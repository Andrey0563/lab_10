...
'''
Як показали багаторазовы тести, для даної задачі доцільніше використання
ітераційного методу розвязку поставленої задачі. Ітераційно задача розвятується
значно швидше. Програма більше читабельна через цикл і вона не потребує рекурсії
'''
